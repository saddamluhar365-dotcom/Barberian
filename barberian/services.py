"""Provider execution with bounded failover and circuit-breaker feedback."""
...
class ProviderExecutor:
    def __init__(self, router: SmartRouter, adapters: Mapping[str, ProviderAdapter], registry: ProviderRegistry | None = None) -> None:
        self.router = router
        ...
        for spec in candidates:
            ...
            try:
                ...
                return ExecutionResponse(
                    ...
                    provider=normalized.provider or spec.name,
                    model=normalized.model or spec.model,
